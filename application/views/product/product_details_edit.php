				...
				<form role="form" class="validate" method="post" action="<?php echo base_url('product/productDetailsEditPost'); ?>">
					<div class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="s_title" data-msg-required="<?php echo $lang['s_title'];?>" value="<?php echo $userData['0']['s_title'];?>"/>
							</div>
						</div>
						<div class="form-group-separator"></div>
						<!--img json decode-->
						<?php $img = json_decode($userData['0']['img_url']);?>
						<div class="form-group">
							<label class="col-sm-2 control-label" ><?php echo $lang['images']?></label>
							<div class="col-sm-6">
								<input type="text" class="form-control" id="imgUrl1" name="img_url[]" placeholder="<?php echo $lang['img_url'];?>" value="<?php echo $img[0];?>"/>
							</div>
							<div class="col-sm-2">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" ><?php echo $lang['images']?></label>
							<div class="col-sm-6">
								<input type="text" class="form-control" id="imgUrl2" name="img_url[]" placeholder="<?php echo $lang['img_url'];?>" value="<?php echo $img[1];?>"/>
							</div>
							<div class="col-sm-2">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" ><?php echo $lang['images']?></label>
							<div class="col-sm-6">
								<input type="text" class="form-control" id="imgUrl3" name="img_url[]" placeholder="<?php echo $lang['img_url'];?>" value="<?php echo $img[2];?>"/>
							</div>
							<div class="col-sm-2">
